...
function addOne(x) {
	...
	// takes in an input of the number
	return x + 1
...
function isPositiveOdd (x) {
	// input is greater than zero and the number has to be odd
	if ( x > 0 && x % 2 !== 0) {
		return true;
	} else {
		return false;}
...
function median(x){
	if (x.length % 2 !== 0) {
		var inputOdd =x.length / 2 - 0.5;
		return x[inputOdd];
		console.log(inputOdd)
	} else {
		var inputEven =x.length / 2
		return (x[inputEven] + x[(inputEven - 1)]) / 2
	}

// var inputEven =x.length / 2
// return (x[inputEven] + x[(inputEven - 1)]) / 2
// console.log(inputEven)
// console.log(x[inputEven])
// console.log(x[(inputEven - 1)])
// console.log((x[inputEven] + x[(inputEven - 1)]) / 2 )
// return x[inputEven] + x[inputEven]
...
function onlyPositiveEvens(x) {
	var posCount = onlyPositiveNumbers(x);
	console.log(posCount)
	var even = onlyEvenNumbers(posCount);
	console.log(even)
	return even
}
...
function onlyPositiveOdds(x) {
	var posCount = onlyPositiveNumbers(x);
	var odd = onlyOddNumbers(posCount);
	return odd;
}
...
function onlyNegativeEvens(x) {
	var posCount = onlyNegativeNumbers(x);
	console.log(posCount)
	var even = onlyEvenNumbers(posCount);
	console.log(even)
	return even
...
function shortestString(x) {
	var reduceString = x.reduce(function(a,b) {
		console.log(a)
...
function getAverageBookPrice(x) {
	var bookTotal = totalOfBookPrices(x)
	return bookTotal / x.length;
}
...
function mostSpentOnItem(x) {
	var stored = x.items;
	console.log(stored.reduce(function(a, b) {
	...
	console.log(stored)
	console.log(x.items[0].quantity)
}
